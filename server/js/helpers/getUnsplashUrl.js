...
const getUnsplashUrl = (pageNumber) =>  {
    const baseUrl = 'https://cors-anywhere.herokuapp.com/https://api.unsplash.com/photos/?client_id='
...
const getUnsplashDetail = (id) =>  {
    const baseUrl = `https://cors-anywhere.herokuapp.com/https://api.unsplash.com/photos/${id}?client_id=`
    const unsplash = 'd633cd88d3ab4d70df0bfa48b64ee1241d0d56f25c16a78e451f20172dbda585'
